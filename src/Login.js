...
const Login = () => {
    ...
    // const login = () => {
    //     const cekUser = [setUser, username, password];
    //     if (cekUser) {
    //         redirect("/dashboard")
    //     }
    // }
                ...
                <div>
                    ...
                    <svg className="mx-auto h-12 w-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 3193.87 1080">
                        <g id="Layer_4" data-name="Layer 4">
                            ...
                            <path class="cls-3" d="M2312.71,900.4q-14.86,0-25.57-5.31a36.7,36.7,0,0,1-16.47-16.2q-5.74-10.87-5.75-28V779a4.43,4.43,0,0,1,1.06-3.1,3.88,3.88,0,0,1,3-1.15h9a4,4,0,0,1,4.25,4.25v72.21q0,17.35,8.14,25.67t22.3,8.32q14,0,22.22-8.32t8.23-25.67V779a4.18,4.18,0,0,1,1.15-3.1,3.93,3.93,0,0,1,2.92-1.15h9.2a4,4,0,0,1,2.92,1.15,4.18,4.18,0,0,1,1.15,3.1v71.86q0,17.17-5.75,28a36.83,36.83,0,0,1-16.37,16.2Q2327.76,900.4,2312.71,900.4Z" /><path class="cls-3" d="M2392,932.26a3.93,3.93,0,0,1-4.07-4.07V810.66a3.93,3.93,0,0,1,4.07-4.07h8.15a3.93,3.93,0,0,1,4.07,4.07v7.79a33.84,33.84,0,0,1,11.33-9.74q7.07-3.88,17.7-3.89,9.9,0,16.9,3.36a31.52,31.52,0,0,1,11.5,9.21,41.74,41.74,0,0,1,6.82,13.27,58,58,0,0,1,2.48,15.93q.16,2.83.17,6t-.17,6a58.42,58.42,0,0,1-2.48,15.84,40.41,40.41,0,0,1-6.82,13.27,32.81,32.81,0,0,1-11.5,9.21q-7,3.45-16.9,3.45-10.27,0-17.26-3.81a36.08,36.08,0,0,1-11.42-9.47v41.07a4.13,4.13,0,0,1-1.06,2.92,3.92,3.92,0,0,1-3,1.15Zm37.53-46.2q9.19,0,14.42-4a22.23,22.23,0,0,0,7.53-10.44,48.29,48.29,0,0,0,2.65-13.9q.18-5.13,0-10.26a48.29,48.29,0,0,0-2.65-13.9,22.23,22.23,0,0,0-7.53-10.44q-5.22-4-14.42-4-8.67,0-14.07,4.07a24.15,24.15,0,0,0-8,10.35,39.5,39.5,0,0,0-2.92,12.83c-.12,1.89-.18,4.14-.18,6.73s.06,4.9.18,6.9a31.42,31.42,0,0,0,2.92,12.22,24.39,24.39,0,0,0,8.23,9.91Q2421.21,886.06,2429.53,886.06Z" />
