                        ...
                        <div className="rounded-xl border p-5 shadow-md h-full w-full bg-white">
                            <form>
                                <div className="grid grid-cols-4 gap-4">
                                    ...
                                    <div>
                                        <div>
                                            <label htmlFor="countries" className="block mb-2 text-sm text-left font-medium text-gray-900 dark:text-gray-400">Pilih Modul</label>
                                    ...
                                    <div>
                                        ...
                                        <div className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                            <Dropdown
                                                label="Tools & Report"
                                                placement="right"
                                            >
