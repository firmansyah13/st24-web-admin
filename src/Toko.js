                            ...
                            <div role="alert" className="container mx-auto w-11/12 md:w-2/3 max-w-lg">
                                <div className="relative py-8 px-5 md:px-10 bg-white shadow-md rounded border border-gray-400">
                                    ...
                                    <div className="flex items-center justify-start w-full">
                                        ...
                                        <button className="focus:outline-none focus:ring-2 focus:ring-offset-2  focus:ring-gray-400 ml-3 bg-gray-100 transition duration-150 text-gray-600 ease-in-out hover:border-gray-400 hover:bg-gray-300 border rounded px-8 py-2 text-sm" onClick={() => setShowModalEdit(false)}>Cancel</button>
                                    </div>
                                    <button className="cursor-pointer absolute top-0 right-0 mt-4 mr-5 text-gray-400 hover:text-gray-600 transition duration-150 ease-in-out rounded focus:ring-2 focus:outline-none focus:ring-gray-600" onClick={() => setShowModalEdit(false)} aria-label="close modal" role="button">
            ...
            <div className="h-full flex-1">
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="min-h-screen text-gray-900">
                        <main className="w-full sm:px-6 lg:px-8 pt-4">
                            {/* <div className="">
                            </div> */}
                            <div className="">
